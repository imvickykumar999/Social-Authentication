...
app.secret_key = "vicky"  #it is necessary to set a password when dealing with OAuth 2.0
os.environ["OAUTHLIB_INSECURE_TRANSPORT"] = "1"  #this is to set our environment to https because OAuth 2.0 only supports https environments

GOOGLE_CLIENT_ID = "400377133938-ja23co2plu1bvp3rktdqkrh7hblm38qf.apps.googleusercontent.com"  #enter your client id you got from Google console
